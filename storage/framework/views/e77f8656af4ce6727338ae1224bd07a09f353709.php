        ...
        <?php foreach($posts as $post): ?>
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="row" data-postId="<?php echo e($post['post_id']); ?>">
                        <div class="col-md-12 col-xs-12 text-center" id="image-post">
                            <a href="<?php echo e(route('user-post-single', ['id'=> $post['post_id']])); ?>">
                                <img src="<?php echo e(url('images/'.$post['post_id'].'.jpg')); ?>" class="img-thumbnail">
                            </a>
                        </div>
                        <div class="col-md-12 col-xs-12 action">
                            <div class="row text-center interaction">
                                <div class="col-md-3 col-xs-3" id="star-button">
                                    <a role="button" style="<?php echo e(($post['isLiked'])? 'display: none;' : ''); ?>" class="like-button"> <span class="glyphicon glyphicon-star-empty"></span> <span id="count-like"><?php echo e($post['likeCount']); ?> <?php echo e(($post['likeCount'] <= 1)? 'Star' : 'Stars'); ?></span></a>
                                    <a role="button" style="<?php echo e(($post['isLiked'])? '' : 'display: none;'); ?>" class="unlike-button"> <span class="glyphicon glyphicon-star"></span> <span id="count-unlike"><?php echo e($post['likeCount']); ?> <?php echo e(($post['likeCount'] <= 1)? 'Star' : 'Stars'); ?></span></a>
                                </div>
                                ...
                                <div class="col-md-3 col-xs-3">
                                    <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <ul class="dropdown-menu">
                                            <?php if(auth()->user()->username == $post['username']): ?>
                                            <li><a role="button" class="remove-button"><span class="glyphicon glyphicon-remove"></span> Delete</a></li>
                                            <li><a role="button" data-post-id="<?php echo e($post['post_id']); ?>" class="edit-caption-button"><span class="glyphicon glyphicon-pencil"></span> Edit Caption</a></li>

                                            <?php endif; ?>
                                            <li><a role="button" class="download-button" href="<?php echo e(url('images/'.$post['post_id'].'.jpg')); ?>" download="<?php echo e(md5(date('Y-m-d h:i:s').auth()->user()->username . $post['post_id']).'.jpg'); ?>"><span class="glyphicon glyphicon-download-alt"></span> Download</a></li>
                                        </ul>
                                    </a>
                                </div>
                                <div class="col-md-3 col-xs-3">
                        ...
                        <div class="col-md-12 col-xs-12 post">
                            ...
                            <div class="timeline-text">
                                <div class="account-info">
                                    <img src="<?php echo e(url('avatars/'.$post['avatar'])); ?>" class="img-thumbnail image-info"/>
                                    <div class="identity-info">
                                        <h4 class="name-info"><a href="<?php echo e(route('user-profile', ['username' => $post['username']])); ?>" role="button"><?php echo e($post['full_name']); ?> <?php echo ($post['is_admin'])? '<span style="font-size: 45%;" class="label label-primary">Admin</span>' : ''; ?></a></h4>
                                        <h5 class="id-info"><a href="<?php echo e(route('user-profile', ['username' => $post['username']])); ?>" role="button"> <?php echo e('@'.$post['username']); ?> </a></h5>
                                    </div>
                                </div>
                                <div class="status">
                                ...
                                <div class="comment row">
                                    ...
                                    <div class="comment-list col-xs-12">
                                        <div class="row">
                                            <div class="col-xs-11">
                                                <div class="comment-name"><a href="<?php echo e(route('user-profile', ['username' => $comment['username']])); ?>" role="button"><?php echo e('@'.$comment['username']); ?></a> : </div>
                                                <div class="comment-content"><?php echo e($comment['comment']); ?> </div>
                                            </div>
                                            <div class="col-xs-1">
                                                <?php if($comment['username'] === auth()->user()->username ): ?>
                                                <a class="delete-comment-btn" data-comment-id="<?php echo e($comment['id']); ?>" role="button"><span class="glyphicon glyphicon-remove"></span></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $('.like-button').on('click', function(event){
                ...
                $.ajax({
                    method: 'POST',
                    url: "<?php echo e(route('api-user-like')); ?>",
            ...
            $('.unlike-button').on('click', function(event){
                ...
                $.ajax({
                    method: 'POST',
                    url: "<?php echo e(route('api-user-unlike')); ?>",
                    data: 'post_id='+post_id,
                })
                .done(function (msg) {
                    var res = msg;
            ...
            $('.form-comment').on('submit', function (event) {
                ...
                if(post_id === undefined){
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(route('api-user-comment')); ?>",
            ...
            function addComment(str){
                ...
                var b = '<a href="<?php echo e(route('user-profile', '')); ?>/'+str.username+'" role="button">@'+str.username+'</a> : </div>';
            ...
            $('.remove-button').on('click', function (event) {
                ...
                if(post_id !== undefined){
                    if(confirm("Are you sure to delete this image ?")){
                        $.ajax({
                            method: 'POST',
                            url: "<?php echo e(route('api-user-delete-post')); ?>",
                            data: 'post_id='+post_id,
                        })
                        .done(function (msg) {
                            var res = msg;
            ...
            $('.form-report').on('submit', function (e) {
                ...
                $.ajax({
                    method: 'POST',
                    url: "<?php echo e(route('api-user-send-report')); ?>",
                    data: $(this).serialize(),
                })
                .done(function (msg) {
                    var res = msg;
            ...
            $('.delete-comment-btn').on('click', function (e) {
                ...
                if(confirm("Are you sure to delete this comment ?")){
                    $.ajax({
                        method: 'POST',
                        url: "<?php echo e(route('api-user-delete-comment')); ?>",
            ...
            $('.form-ch-caption').on('submit', function (e) {
                ...
                if(confirm("Are you sure to change caption?"))
                {
                    $.ajax({
                        method: 'POST',
                        url: "<?php echo e(route('api-user-edit-caption')); ?>",
                        data: $(this).serialize(),
                    })
                    .done(function (msg) {
                        var res = msg;
